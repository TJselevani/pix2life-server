...
const validateUserSignUpInput = (req, res, next) => {
  const validationRules = [
    ...
    check('postCode')
      .not().isEmpty().withMessage('Post Code is required'),
...
module.exports = { validateUserLoginInput, validateUserPasswordInput, validateUserSignUpInput, validateUserEmailInput } ;

...
class VideoService {
  ...
  static saveVideoToMemory = async (req) => {
  ...
  static UploadVideoToFirestoreDB = async (file, userId) => {
    try {
      ...
      throw new InternalServerError(
        `Unable to upload video to Firebase, ${error.message}`
      );
    }
  };
  //################################################################## SAVE VIDEO TO DATABASE ######################################################################//
  static UploadVideoToDB = async (
    userId,
    file,
    downloadURL,
    publicId,
    ...
    try {
      ...
      throw new InternalServerError(
        `Unable to Save Video to Database, ${error.message}`
      );
    }
  };
  ...
  static getAllUserVideos = async (user) => {
    try {
      ...
      throw new InternalServerError(
        `Unable to retrieve ${user.username}'s videos`
      );
    }
  };
